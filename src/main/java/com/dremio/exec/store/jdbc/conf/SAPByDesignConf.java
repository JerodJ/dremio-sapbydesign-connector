...
@SourceType(value = "SAPByDesignARP", label = "SAPByDesign",uiConfig = "sapbydesign-layout.json")
public class SAPByDesignConf extends AbstractArpConf<SAPByDesignConf> {
  private static final String ARP_FILENAME = "arp/implementation/sapbydesign-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sapbydesign.SAPByDesignDriver";
